...
func (s *SSEServerTransport) Send(ctx context.Context, msg *ts.BaseJsonRpcMessage) error {
...
func (s *SSEServerTransport) SetMessageHandler(handler func(ctx context.Context, msg *ts.BaseJsonRpcMessage)) {
